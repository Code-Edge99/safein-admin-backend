...
export class WorkTypesController {
  ...
  create(@Req() req: AuthenticatedAdminRequest, @Body() createWorkTypeDto: CreateWorkTypeDto): Promise<WorkTypeResponseDto> {
  ...
  findAll(@Req() req: AuthenticatedAdminRequest, @Query('organizationId') organizationId?: string): Promise<WorkTypeResponseDto[]> {
  ...
  @ApiResponse({ status: 200, description: '근무 유형 목록', type: [WorkTypeResponseDto] })
  findByOrganization(@Req() req: AuthenticatedAdminRequest, @Param('orgId') orgId: string): Promise<WorkTypeResponseDto[]> {
  ...
  findOne(@Req() req: AuthenticatedAdminRequest, @Param('id') id: string): Promise<WorkTypeDetailDto> {
  ...
  toggleActive(@Req() req: AuthenticatedAdminRequest, @Param('id') id: string): Promise<WorkTypeResponseDto> {
